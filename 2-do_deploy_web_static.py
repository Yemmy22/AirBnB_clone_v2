...
def do_deploy(archive_path):
    ...
    try:
        ...
        run('rsync -aI /data/web_static/releases/{}/{}/* /data/web_static/releases/{}/'.format(archive_dir, file_name, archive_dir))

        # Delete the empty archive directory
        run('rm -rf /data/web_static/releases/{}/{}'.format(archive_dir, file_name))
