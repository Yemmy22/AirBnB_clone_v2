...
class test_State_FileStorage(unittest.TestCase):
    '''
    Subclass of unittest.Testcases. Performs unittest on
    all instances of State class.
    '''
    def setUp(self):
        '''
    ...
    def test_save(self):
        ...
        loaded_obj = State(**self.obj.to_dict())
